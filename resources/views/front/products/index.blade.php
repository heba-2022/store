...
<div class="ps-banner">
        ...
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            ...
            <h3 class="ps-section__title" data-mask="features">- Features Products</h3>
             <br>
             <a class="ps-shoe__overlay" href="{{ route('home2') }}"><b>More...</b></a>
          </div>
                  ...
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail">
                        ...
                        <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ $product->image_path}}"  alt=""><a class="ps-shoe__overlay" href="{{ route('show', $product->slug) }}"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}"  alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}"  alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}"  alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}"  alt=""></div>
      ...
      <div class="ps-section--offer">
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="{{asset('assets/store/images/banner/home-banner-1.png')}}"  alt=""></a></div>
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="{{asset('assets/store/images/banner/home-banner-2.png')}}"  alt=""></a></div>
      </div>
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                    <div class="ps-hotspot"><a class="point first active" href="javascript:;"><i class="fa fa-plus"></i>
                        ...
                        <div class="ps-hotspot__content">
                          <p class="heading">JUMP TO HEADER</p>
                          <p>Dynamic Fit Collar en la zona del tobillo que une la parte inferior de la pierna y el pie sin reducir la libertad de movimiento.</p>
                        </div></a><img src="{{asset('assets/store/images/hot-deal.png')}}"  alt=""></div>
                  </div>
            </div>
          </div>
        </div>
      ...
      <div class="ps-section ps-section--top-sales ps-owl-root pt-80 pb-80">
        <div class="ps-container">
          ...
          <div class="ps-section__content">
           ...
           @foreach($top_sallers as $product)
            <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ $product->image_path}}"  alt=""><a class="ps-shoe__overlay" href="{{ route('show', $product->slug) }}"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/store/images/shoe/2.jpg')}}"  alt=""><img src="{{asset('assets/store/images/shoe/3.jpg')}}"  alt=""><img src="{{asset('assets/store/images/shoe/4.jpg')}}"  alt=""><img src="{{asset('assets/store/images/shoe/5.jpg')}}"  alt=""></div>
        ...
        <div class="ps-container">
          ...
          <div class="ps-section__content">
            <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                      <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{asset('assets/store/images/blog/3.jpg')}}"  alt=""></div>
