                        ...
                        <div class="ps-product__thumbnail">
                            <div class="ps-product__preview">
                                <div class="ps-product__variants">
                                    <div class="item"><img src="{{$product->image_path}}" alt=""></div>
                                    <div class="item"><img src="{{$product->image_path}}" alt=""></div>
                            ...
                            <div class="ps-product__image">
                                <div class="item"><img class="zoom" src="{{$product->image_path}}" alt="" data-zoom-image="images/shoe-detail/1.jpg"></div>
                                <div class="item"><img class="zoom" src="{{$product->image_path}}" alt="" data-zoom-image="images/shoe-detail/2.jpg"></div>
                                <div class="item"><img class="zoom" src="{{$product->image_path}}" alt="" data-zoom-image="images/shoe-detail/3.jpg"></div>
                            </div>
                        </div>
                  ...
                  <ul>
                    ...
                    <li><a href="product-detail.html"><img src="images/shoe/sidebar/2.jpg" alt=""></a></li>
                            ...
                            <div class="ps-product__block ps-product__size">
                                <h4>CHOOSE QUANTITY<a href="#">Size chart</a></h4>
                                <select name="quantity" class="ps-select selectpicker">
                            ...
                            <div class="ps-product__shopping"><button class="ps-btn mb-10" dtype="submit">Add to cart<i class="ps-icon-next"></i></button>
                        ...
                        <div class="tab-content mb-60">
                            ...
                            <div class="tab-pane" role="tabpanel" id="tab_02">
                                ...
                                <p class="mb-20"> 1 review for <strong>{{$product->name}}</strong></p>
                                <div class="ps-review">
                                    ...
                                    <div class="ps-review__content">
                                        <header>
                                            ...
                                            <p>By<a href=""> {{ $review->user->name }}</a> - November 25, 2017</p>
                                        </header>
                                        <p> {{ $review->review }}</p>
                                    </div>
                                </div>
                                ...
                                <form class="ps-product__review" action="{{ route('review') }}" method="post">
                                    @csrf
                            ...
                            <div class="tab-pane" role="tabpanel" id="tab_03">
                                <ul>
                                    ...
                                    <li style="color:green; "> - {{ $tag->name }}</li>
                                    @endforeach
                                </ul>
