...
{{--
                           ...
                           --}}
                        <tr>
                            <td><a class="ps-product__preview" href="{{ route('show', $item->product->slug) }}"><img class="mr-15" src="{{$item->product->image_path}}" width="100px" height="100px" alt="">{{ $item->product->name}}</a></td>
